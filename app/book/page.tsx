...
<path fillRule="evenodd" clipRule="evenodd" d="M1.5 3C1.22386 3 1 3.22386 1 3.5C1 3.77614 1.22386 4 1.5 4H13.5C13.7761 4 14 3.77614 14 3.5C14 3.22386 13.7761 3 13.5 3H1.5ZM1 7.5C1 7.22386 1.22386 7 1.5 7H13.5C13.7761 7 14 7.22386 14 7.5C14 7.77614 13.7761 8 13.5 8H1.5C1.22386 8 1 7.77614 1 7.5ZM1 1１.5C1 １.2239 １.22386 １.0 １.5 １.0H１３.5C１３.７７６１ １.0 １４ １.２２３９ １４ １.５C１４ １.７７６１ １３.７７６１ ２．０ １３．５ ２．０H１．５C１．２２３８６ ２．０ １ １．７７６１ １ １．５Z" fill="currentColor"></path>
</svg>
</div>
</div>
</div>
...
<div className="sidebar__link--line "></div>
<div className="sidebar__icon--wrapper">
<svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle>
...
<div className="inner-book__total--rating">(608&nbsp;ratings)</div>
</div>
<div className="inner-book__description">
<div className="inner-book__icon">
<svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
